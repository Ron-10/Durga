...
import { Trophy, Search, Download, UserCheck } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h1 className="text-6xl font-bold text-gray-900 mb-4">Examination Results</h1>
        ...
        <div className="mb-16">
          <div className="bg-white p-8 rounded-3xl shadow-2xl">
            <h2 className="text-3xl font-bold mb-6 text-center">Find Your Result</h2>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 items-end">
              ...
              <div className="md:col-span-1">
                <button className="w-full flex items-center justify-center px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors duration-200">
